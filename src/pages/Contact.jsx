  ...
  return (
    <div>{landlord!==null && (
        <div className='flex flex-col w-full'>
            ...
            <a href={`mailto:${landlord.email}?Subject=${listing.name}&body=${message}`}><button className='px-7 py-3 bg-blue-600 text-whiye rounded text-sm uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition ease-in-out duration-150 w-full text-center text-white mb-6' type="button">Send Message</button></a>
        </div>
    )}</div>
  )
}
