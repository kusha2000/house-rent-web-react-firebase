      ...
      <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form >
            ...
            <input type="email" id="email" value={email} disabled onChange={onChange} className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out'/>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p className='flex items-center'>Do you want to change your name?
                ...
                }} className="text-red-600 hover:text-red-700 ml-1 cursor-pointer">{changeDetail?"Apply change":"Edit"}</span>
              </p>
          ...
          <button type="submit" className='w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm font-medium rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>
            <Link to="/create-listing" className='flex justify-center items-center'>
              <FcHome className='mr-2 text-3xl bg-green-200 rounded-full p-1 border-2'/>
