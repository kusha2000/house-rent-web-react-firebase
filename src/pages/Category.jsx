    ...
    <div className='max-w-6xl mx-auto px-3'>
      ...
      {loading ?(
        ...
        <>
          ...
          {lastFetchedListing && (
            <div>
              <button onClick={onFetchMoreListings} className='bg-wite px-3 py-1.5 text-gray-700 border border-gray-300 mb-3 mt-6 hover:border-slate-600 rounded transition duration-150 ease-in-out'>Load More</button>
            </div>
          )}
        </>
      ) : (
